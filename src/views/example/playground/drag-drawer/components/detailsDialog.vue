<template>
  <admin-drawer
    ...
    :width.sync="dialogForm.width"
    :min-width="dialogForm.minWidth"
    :placement="dialogForm.placement"
  ...
  >
    ...
    <div v-loading="loading">
      ...
      <el-form v-else ref="dataForm" :model="temp" label-position="right" label-width="120px">
        ...
        >
          <admin-tinymce v-if="!loading" :id="`${id}`" ref="content" v-model="temp.content" :height="200" />
        </el-form-item>
