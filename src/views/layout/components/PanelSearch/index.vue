<template>
  ...
  >
    ...
    >
      <svg-icon icon-class="logo" class-name="card-panel-icon panel-search__logo" />
      <el-autocomplete
        ref="input"
        v-model="searchText"
...
export default {
  components: {
    'admin-panel-search-item': () => import('./components/panel-search-item/index.vue')
  },
  mixins: [
    mixin
  ],
