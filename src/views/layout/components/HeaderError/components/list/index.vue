<template>
  ...
  >
    ...
    <el-table-column type="expand">
      <div slot-scope="props" class="admin-error-log-list__expand-group">
        <expand-item
          :type="props.row.type"
          title="类型"
    ...
    >
      <template slot-scope="scope">
        ...
        <el-tag
          ...
          type="info"
        >
          <admin-icon name="dot-circle-o" /> Log
        </el-tag>
      </template>
    </el-table-column>
...
<style lang="scss">
.admin-error-log-list__expand-group {
  .admin-error-log-list__expand {
    padding-left: 20px;
    margin-bottom: 10px;
    &:last-child {
      margin-bottom: 0px;
    }
    .admin-error-log-list__expand-title {
      font-size: 16px;
      font-weight: bold;
      margin-top: 0px;
      margin-bottom: 10px;
    }
    .admin-error-log-list__expand-value {
      font-size: 12px;
      margin-top: 0px;
      margin-bottom: 0px;
    }
  }
  .admin-error-log-list__expand--log {
    border-left: 4px solid $color-info;
  }
  .admin-error-log-list__expand--error {
